...
.PARAMETER Clean
Removes the image minor.cursussite and kills all containers based on that image.
...
Build a Docker image named minor.cursussite
#>
...
$imageName="minor.cursussite"
$projectName="minorcursussen"
$serviceName="minor.cursussite"
