...
.PARAMETER Clean
Removes the image minor.cursusbeheer and kills all containers based on that image.
...
Build a Docker image named minor.cursusbeheer
#>
...
$imageName="minor.cursusbeheer"
$projectName="minorcursussen"
$serviceName="minor.cursusbeheer"
