...
namespace Minor.Case1.FrontEnd.FrontEnd.Agents.Models
{
    ...
    public partial class Inschrijving
    {
        ...
        /// Initializes a new instance of the Inschrijving class.
        /// </summary>
        public Inschrijving(int? id = default(int?), int? cursistId = default(int?), int? cursusInstantieId = default(int?), CursusInstantie instantie = default(CursusInstantie), Cursist cursist = default(Cursist))
        {
            Id = id;
            CursistId = cursistId;
